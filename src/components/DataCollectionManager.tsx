                  ...
                  <tr key={record.id} className="hover:bg-stone-50/70">
                    ...
                    <td className="px-3 py-3">
                      <div className="flex justify-end gap-1">
                        <button type="button" onClick={() => startEdit(record)} className="p-2 rounded-lg hover:bg-stone-100 text-stone-600">
                          <Edit2 className="w-4 h-4" />
                        </button>
                        <button type="button" onClick={() => handleDelete(record)} className="p-2 rounded-lg hover:bg-red-50 text-red-600">
